...
ativar.addEventListener("click", () => {
    ...
    if (x==8){
        ola.classList.toggle("animar2");
        x = "<img src='Samuel.png'  width='100px'> <img src='Apollo.jpg' height='100px' width='100px'> <img src='Gabriel.jpg'  width='100px'><br><audio controls><source src='kkk.mp3' type='audio/mpeg'></audio> "
    ...
    if (x==12){
        ola.classList.toggle("animar2");
        x = "<i><b> Voce encontrou um pote de ouro!!!</b><a href='https://docs.google.com/document/d/1vdwPwmG5nkhHB4sCChfB0NqdADCbBIQv5DzqftEA7jQ/edit?usp=drivesdk'>deixe um comentario no nosso mural</i>"
    }
    ant = x;
